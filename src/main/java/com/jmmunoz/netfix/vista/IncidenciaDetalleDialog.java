...
public class IncidenciaDetalleDialog extends JDialog {
        ...
        /**
         * Crea un nuevo diálogo de detalles de incidencia.
         * 
         * @param owner        Ventana padre del diálogo.
         * @param idIncidencia ID de la incidencia a mostrar.
         */
        ...
        /**
         * Crea una sección visual con título y área de contenido.
         * 
         * @param title       Título de la sección.
         * @param contentArea Panel donde se añadirá el contenido.
         * @return El panel contenedor de toda la sección.
         */
        ...
        /**
         * Carga los datos de la incidencia, cliente, contrato, comentarios y
         * dispositivos.
        ...
        /**
         * Añade una fila de detalle "Etiqueta: Valor" al panel especificado.
         * 
         * @param contentPanel Panel donde añadir la fila.
