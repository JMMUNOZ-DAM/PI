...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        // Ancho fijo para justificar iconos en columna
        ...
        estaButton.setText(" " + com.jmmunoz.netfix.config.AppConfig.getInstance().getMessage("main.nav.stats").trim());
        ...
        inciButton.setText(
                " " + com.jmmunoz.netfix.config.AppConfig.getInstance().getMessage("main.nav.incidents").trim());
        ...
        aparaButton
                .setText(" " + com.jmmunoz.netfix.config.AppConfig.getInstance().getMessage("main.nav.devices").trim());
        ...
        usuButton.setText(" " + com.jmmunoz.netfix.config.AppConfig.getInstance().getMessage("main.nav.users").trim());
        ...
        adminButton
                .setText(" " + com.jmmunoz.netfix.config.AppConfig.getInstance().getMessage("main.nav.admin").trim());
